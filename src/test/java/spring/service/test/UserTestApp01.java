...
public class UserTestApp01 {
	public static void main(String[] args) {
		 ...
		 */
//		BeanFactory factory = 
//				new XmlBeanFactory(new FileSystemResource("./src/main/resources/config/userservice01.xml"));  // 후진 공장
		/*
		 ...
		 */
		ApplicationContext factory = new ClassPathXmlApplicationContext("/config/userservice.xml");  // 후진 공장 대신 신식 공장
		// FilePath 는 src를 인식 못함. 따라서 src부터 시작해야 한다
		// ClassPath 로 시작하는 건  src 를 애초에 인식해서 갖고 시작한다 따라서 src/main/resources 부터 인식하기 때문에 빼고 시작해야 한다
